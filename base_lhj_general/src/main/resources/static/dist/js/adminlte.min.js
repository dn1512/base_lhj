...
!function (t, e) {
    ...
    "use strict";
    var e = function (t) {
        var e = "ControlSidebar", i = "lte.controlsidebar", n = t.fn[e],
            s = {COLLAPSED: "collapsed.lte.controlsidebar", EXPANDED: "expanded.lte.controlsidebar"},
            o = ".control-sidebar", a = ".control-sidebar-content", r = '[data-widget="control-sidebar"]',
            l = ".main-header", c = ".main-footer", d = "control-sidebar-animate", h = "control-sidebar-open",
            f = "control-sidebar-slide-open", u = "layout-fixed", g = "layout-navbar-fixed",
            _ = "layout-sm-navbar-fixed", p = "layout-md-navbar-fixed", m = "layout-lg-navbar-fixed",
            C = "layout-xl-navbar-fixed", v = "layout-footer-fixed", y = "layout-sm-footer-fixed",
            b = "layout-md-footer-fixed", w = "layout-lg-footer-fixed", D = "layout-xl-footer-fixed", E = function () {
                function e(t, e) {
                ...
                return n.show = function () {
                    ...
                    }, i = Math.abs(e.window + t(window).scrollTop() - e.scroll), n = t(window).scrollTop(), s = !1, r = !1;
                    ...
                    var e = t(window).height(), i = t(l).outerHeight(), n = t(c).outerHeight();
        ...
        var e = "Layout", i = t.fn[e], n = ".main-header", s = ".main-sidebar", o = ".main-sidebar .sidebar",
            a = ".content-wrapper", r = ".main-footer", l = '[data-widget="pushmenu"]', c = ".login-box",
            d = ".register-box", h = "sidebar-focused", f = "layout-fixed", u = "login-page", g = "register-page",
            _ = {scrollbarTheme: "os-theme-light", scrollbarAutoHide: "l"}, p = function () {
                function e(t, e) {
                ...
                return i.fixLayoutHeight = function () {
                    ...
                    return this.each((function () {
                        var n = t(this).data("lte.layout"), s = t.extend({}, _, t(this).data());
        ...
        var e = "PushMenu", i = ".lte.pushmenu", n = t.fn[e], s = {COLLAPSED: "collapsed" + i, SHOWN: "shown" + i},
            o = {autoCollapseSize: 992, enableRemember: !1, noTransitionAfterReload: !0}, a = {
                ...
                WRAPPER: ".wrapper"
            }, r = "sidebar-collapse", l = "sidebar-open", c = function () {
                function e(e, i) {
                ...
                return n.show = function () {
                    ...
                    var e = this, i = t("<div />", {id: "sidebar-overlay"});
                    i.on("click", (function () {
                        e.collapse()
                    })), t(a.WRAPPER).append(i)
                }, e._jQueryInterface = function (i) {
                    return this.each((function () {
                        var n = t(this).data("lte.pushmenu"), s = t.extend({}, o, t(this).data());
        ...
        var e = "Treeview", i = t.fn[e], n = {
            ...
            }, s = ".nav-item", o = ".nav-treeview", a = ".menu-open", r = '[data-widget="treeview"]', l = "menu-open",
            c = {trigger: r + " " + ".nav-link", animationSpeed: 300, accordion: !0}, d = function () {
                function e(t, e) {
                ...
                return i.init = function () {
                    ...
                    var s = this, r = t.Event(n.EXPANDED);
                    if (this._config.accordion) {
                        var c = i.siblings(a).first(), d = c.find(o).first();
                        this.collapse(d, c)
                    }
                    ...
                    var s = this, r = t.Event(n.COLLAPSED);
                    ...
                    var i = t(e.currentTarget), n = i.parent(), a = n.find("> " + o);
                    ...
                    return this.each((function () {
                        var n = t(this).data("lte.treeview"), s = t.extend({}, c, t(this).data());
        ...
        var e = "DirectChat", i = t.fn[e], n = "toggled{EVENT_KEY}", s = '[data-widget="chat-pane-toggle"]',
            o = ".direct-chat", a = "direct-chat-contacts-open", r = function () {
                function e(t, e) {
                    this._element = t
                }
        ...
        var e = "TodoList", i = t.fn[e], n = '[data-widget="todo-list"]', s = "done", o = {
            onCheck: function (t) {
                return t
            ...
            return i.toggle = function (e) {
                ...
                return this.each((function () {
                    var n = t(this).data("lte.todolist"), s = t.extend({}, o, t(this).data());
        ...
        var e = "CardWidget", i = ".lte.cardwidget", n = t.fn[e], s = {
                EXPANDED: "expanded" + i,
        ...
        var e = "CardRefresh", i = t.fn[e], n = {
            ...
            return i.load = function () {
                ...
                var n = t(this).data("lte.cardrefresh"), s = t(this).data();
        ...
        var e = "Dropdown", i = t.fn[e], n = "ul.dropdown-menu", s = '[data-toggle="dropdown"]', o = {},
            a = function () {
                function e(t, e) {
                    this._config = e, this._element = t
                }
                ...
                return e.prototype.toggleSubmenu = function () {
                    ...
                    return this.each((function () {
                        var n = t(this).data("lte.dropdown"), s = t.extend({}, o, t(this).data());
        ...
        var e = "Toasts", i = t.fn[e],
            n = {INIT: "init.lte.toasts", CREATED: "created.lte.toasts", REMOVED: "removed.lte.toasts"},
            s = "#toastsContainerTopRight", o = "#toastsContainerTopLeft", a = "#toastsContainerBottomRight",
            r = "#toastsContainerBottomLeft", l = "toasts-top-right", c = "toasts-top-left", d = "toasts-bottom-right",
            h = "toasts-bottom-left", f = "topRight", u = "topLeft", g = "bottomRight", _ = "bottomLeft", p = {
                position: f,
                fixed: !0,
                autohide: !1,
                autoremove: !0,
                ...
                return i.create = function () {
                    ...
                    return this.each((function () {
                        var s = t.extend({}, p, n), o = new e(t(this), s);
                        "create" === i && o[i]()
                    }))
                }, e
            }();
